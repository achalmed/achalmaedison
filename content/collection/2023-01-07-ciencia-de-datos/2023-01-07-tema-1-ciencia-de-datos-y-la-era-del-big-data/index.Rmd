...
tweetrmd::tweet_embed("https://twitter.com/sTeamTraen/status/1361067408660783115", theme = "light", align = "center", dnt = TRUE, plain = TRUE, maxwidth = 400)
```
...
El software libre es de vital importancia en el desarrollo de la investigación reproducible. Piensa que por mucho que un investigador haga accesibles sus datos y su código, si utiliza un software privativo, en realidad su análisis no es reproducible, sólo lo será para aquellos que puedan pagar la licencia^[El software libre o código abierto también es una garantia de transparencia, libertades y derechos, como puede verse en el siguiente [hilo de Twitter](https://twitter.com/dcabo/status/1304418827279773697)].
...
```{r, echo = FALSE, fig.asp = 7/9}
tweetrmd::tweet_embed("https://twitter.com/achalmaedison/status/1597228787431002113", theme = "light", align = "center", dnt = TRUE, plain = TRUE, maxwidth = 400)
```
